...
<head>
    ...
    <!-- page css -->
    <link href="<?= base_url('template/dist/css/pages/error-pages.css'); ?>" rel="stylesheet">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>404</h1>
                <h3 class="text-uppercase">Pagina não foi encontrada !</h3>
                <p class="text-muted m-t-30 m-b-30">PARECE QUE VOCÊ ESTA TENTANDO VOLTAR PARA O INICIO</p>
                <a href="<?= base_url('dashboard'); ?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Voltar para Dashboard</a> </div>
